...
public class AdminPanelController{
	...
	public String departmentStudent(@RequestParam String department,HttpServletRequest request)
	{
	...
	public String departmentActivity(@RequestParam String department,HttpServletRequest request)
	{
		System.out.println(department);
	...
	@RequestMapping("/delete-event-admin{eventid}{department")
	public String deleteEvent(@RequestParam int eventid,@RequestParam String department,HttpServletRequest request)
	{
