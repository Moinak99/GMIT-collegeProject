...
public class TrainingController {
	...
	{
		trainingservice.saveTrainingDetails(trainingmodel);
		List<TrainingModel> cdctraining = trainingservice.getAllTrainingDetails();
