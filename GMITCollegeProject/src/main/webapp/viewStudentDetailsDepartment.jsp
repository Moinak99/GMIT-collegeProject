    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="view-student-bach-latest?batch=${batches[0]}&department=${teacher.teacherDepartment}" >${batches[0]}</a>
          
          <a class="dropdown-item" href="view-student-bach-2ndlatest?batch=${batches[1]}&department=${teacher.teacherDepartment}">${batches[1]}</a>
          
          <a class="dropdown-item" href="view-student-bach-3rdlatest?batch=${batches[2]}&department=${teacher.teacherDepartment}">${batches[2]}</a>
          
          <a class="dropdown-item" href="view-student-bach-4thlatest?batch=${batches[3]}&department=${teacher.teacherDepartment}">${batches[3]}</a>
