...
<div class="row">
    <c:forEach var="user" items="${cdctraining}">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title text-primary">${user.trainingName}</h5>
        <p class="card-text">${user.department}&nbsp;&nbsp;${user.batch}</p>
        <a href="view-training-details?trainingid=${user.trainingid}" class="btn btn-primary">View Details</a>
      </div>
    </div>
  </div>
    </c:forEach> 
